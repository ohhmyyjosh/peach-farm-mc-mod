...
public class ModPlacedFeatures {
    ...
    public static final ResourceKey<PlacedFeature> PEACH_PLACED_KEY = registerKey("peach_placed");
    ...
    private static ResourceKey<PlacedFeature> registerKey(String name) {
        return ResourceKey.create(Registries.PLACED_FEATURE, new ResourceLocation(PeachFarm.MOD_ID, name));
    }
