...
public class PeachTrunkPlacer extends TrunkPlacer {
    public static final Codec<PeachTrunkPlacer> CODEC = RecordCodecBuilder.create(peachTrunkPlacerInstance ->
            trunkPlacerParts(peachTrunkPlacerInstance).apply(peachTrunkPlacerInstance, PeachTrunkPlacer::new));

    public PeachTrunkPlacer(int pBaseHeight, int pHeightRandA, int pHeightRandB) {
