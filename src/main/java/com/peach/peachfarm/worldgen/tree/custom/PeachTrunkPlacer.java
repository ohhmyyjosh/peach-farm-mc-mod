package com.peach.peachfarm.worldgen.tree.custom;
...
//    public static final Codec<PeachTrunkPlacer> CODEC = RecordCodecBuilder.create(peachTrunkPlacerInstance ->
//            trunkPlacerParts(pineTrunkPlacerInstance).apply(peachTrunkPlacerInstance, PeachTrunkPlacer::new));

    public static final Codec<PeachTrunkPlacer> CODEC = RecordCodecBuilder.create((p_273579_) -> {
        ...
        }))).apply(p_273579_, PeachTrunkPlacer::new);
    });
    ...
    public PeachTrunkPlacer(int p_273281_, int p_273327_, int p_272619_, IntProvider p_272873_, IntProvider p_272789_, UniformInt p_272917_, IntProvider p_272948_) {
    ...
    protected TrunkPlacerType<?> type() {
        return ModTrunkPlacerTypes.PEACH_TRUNK_PLACER.get();
    }
    ...
    private FoliagePlacer.FoliageAttachment generateBranch(LevelSimulatedReader pLevel, BiConsumer<BlockPos, BlockState> pPosSetter, RandomSource pRandom, int pFreeTreeHeight, BlockPos pPos, TreeConfiguration pConfig, Function<BlockState, BlockState> pPropertySetter, Direction pDirection, int pSecondBranchStartOffsetFromTop, boolean p_272719_, BlockPos.MutableBlockPos p_273496_) {
        ...
        for(int l = 0; l < k; ++l) {
            this.placeLog(pLevel, pPosSetter, pRandom, p_273496_.move(pDirection), pConfig, pPropertySetter);
        }
        ...
        while(true) {
            ...
            p_273496_.move(flag1 ? direction : pDirection);
            this.placeLog(pLevel, pPosSetter, pRandom, p_273496_, pConfig, flag1 ? Function.identity() : pPropertySetter);
        }
    }
}
