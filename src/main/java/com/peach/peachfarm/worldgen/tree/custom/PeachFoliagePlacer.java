...
public class PeachFoliagePlacer extends FoliagePlacer {
    public static final Codec<PeachFoliagePlacer> CODEC = RecordCodecBuilder.create(peachFoliagePlacerInstance
            -> foliagePlacerParts(peachFoliagePlacerInstance).and(Codec.intRange(0, 16).fieldOf("height")
            .forGetter(fp -> fp.height)).apply(peachFoliagePlacerInstance, PeachFoliagePlacer::new));
    private final int height;

    public PeachFoliagePlacer(IntProvider pRadius, IntProvider pOffset, int height) {
