...
public class PeachFoliagePlacer extends FoliagePlacer {
    ...
    public static final Codec<PeachFoliagePlacer> CODEC = RecordCodecBuilder.create((p_273246_) -> {
        ...
        }))).apply(p_273246_, PeachFoliagePlacer::new);
    });
    ...
    public PeachFoliagePlacer(IntProvider p_272646_, IntProvider p_272802_, IntProvider p_273604_, float p_272737_, float p_273720_, float p_273152_, float p_273529_) {
    ...
    protected FoliagePlacerType<?> type() {
        return ModFoliagePlacers.PEACH_FOLIAGE_PLACER.get();
    }
